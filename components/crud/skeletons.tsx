...
export function Subregionskeleton() {
  return (
...
export function LatestSubregionsSkeleton() {
  return (
    <div
...
export function SubregionsMobileSkeleton() {
  return (
...
export function SubregionsTableSkeleton() {
  return (
    <div className="my-6 flow-root">
      <div className="inline-block min-w-full align-middle">
        <div className="rounded-lg bg-gray-50 p-2 md:pt-0">
          <div className="md:hidden">
            <SubregionsMobileSkeleton />
            <SubregionsMobileSkeleton />
            <SubregionsMobileSkeleton />
            <SubregionsMobileSkeleton />
            <SubregionsMobileSkeleton />
